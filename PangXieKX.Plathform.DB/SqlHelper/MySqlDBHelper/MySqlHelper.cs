...
namespace PangXieKX.Plathform.DB.MySqlDBHelper
{
    ...
    public class MySqlHelper
    {
        #region 私有方法和工具
        //sql
        private static void PrepareCommand(MySqlCommand command, MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, IDataParameter[] commandParameters, out bool mustCloseConnection)
        {
        ...
        //通用
        private static void PrepareCommand(MySqlCommand command, DbConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, IDataParameter[] commandParameters, out bool mustCloseConnection)
        {
        ...
        //通用
        private static void AttachParameters(MySqlCommand command, IDataParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">ＳＱＬ语句或者存储过程参数</param>
        /// <returns>影响的行数</returns>
        public static int ExecuteNonQuery(MySqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            int retval = 0;
            //要检查参数
            MySqlCommand cmd = new MySqlCommand();
        ...
        public static DataSet ExecuteDataset(MySqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            MySqlCommand cmd = new MySqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, connection, (MySqlTransaction)null, commandType, commandText, commandParameters, out mustCloseConnection);
        ...
        public static DataSet ExecuteDataset(IDbTransaction transaction, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            MySqlCommand cmd = new MySqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, (MySqlConnection)transaction.Connection, (MySqlTransaction)transaction, commandType, commandText, commandParameters, out mustCloseConnection);
            using (MySqlDataAdapter da = new MySqlDataAdapter(cmd))
            {
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        //通用
        private static MySqlDataReader ExecuteReader(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, IDataParameter[] commandParameters, bool isClose)
        {
            bool mustCloseConnection = false;
            MySqlCommand cmd = new MySqlCommand();
        ...
        /// <param name="commandParameters">ＳＱＬ语句或者存储过程参数</param>
        /// <returns>执行结果集</returns>
        public static MySqlDataReader ExecuteReader(MySqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
        ...
        /// <param name="commandText">ＳＱＬ语句或者存储过程名</param>n
        /// <returns>执行结果集</returns>
        public static MySqlDataReader ExecuteReader(IDbTransaction transaction, CommandType commandType, string commandText)
        {
            bool mustCloseConnection = false;
            return ExecuteReader((MySqlConnection)transaction.Connection, (MySqlTransaction)transaction, commandType, commandText, (IDataParameter[])null, mustCloseConnection);
        }
        ...
        /// <param name="commandParameters">ＳＱＬ语句或者存储过程参数</param>
        /// <returns>执行结果集</returns>
        public static MySqlDataReader ExecuteReader(IDbTransaction transaction, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            bool mustCloseConnection = false;
            return ExecuteReader((MySqlConnection)transaction.Connection, (MySqlTransaction)transaction, commandType, commandText, commandParameters, mustCloseConnection);
        }
        ...
        public static object ExecuteScalar(MySqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            object retval = null;
            MySqlCommand cmd = new MySqlCommand();
            bool mustCloseConnection = false;
        ...
        public static object ExecuteScalar(IDbTransaction transaction, CommandType commandType, string commandText)
        {
            ...
            MySqlCommand cmd = new MySqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, ((MySqlTransaction)transaction).Connection, (MySqlTransaction)transaction, commandType, commandText, (IDataParameter[])null, out mustCloseConnection);
            retval = cmd.ExecuteScalar();
            cmd.Parameters.Clear();
            return retval;
        }
