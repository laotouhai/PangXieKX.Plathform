...
namespace PangXieKX.Plathform.DB.DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        IEnumerable<TReturn> GetList<T, TReturn>(IDbConnection connection, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered)
            where T : class
            where TReturn : class;
        ...
        IEnumerable<TReturn> GetPage<T, TReturn>(IDbConnection connection, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered)
            where T : class
            where TReturn : class;
    ...
    internal class DapperImplementor : IDapperImplementor
    {
            ...
            where TReturn : class
        {
            ...
            TReturn result = GetList<TReturn>(connection, classMap, predicate, null, transaction, commandTimeout, true).SingleOrDefault();
            return result;
        }
        ...
        public IEnumerable<TReturn> GetList<T, TReturn>(IDbConnection connection, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered)
            where T : class
            where TReturn : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            return GetList<TReturn>(connection, classMap, wherePredicate, sort, transaction, commandTimeout, true);
        }

        public IEnumerable<TReturn> GetPage<T, TReturn>(IDbConnection connection, object predicate, IList<ISort> sort, int page, int resultsPerPage, IDbTransaction transaction, int? commandTimeout, bool buffered)
            where T : class
            where TReturn : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            return GetPage<TReturn>(connection, classMap, wherePredicate, sort, page, resultsPerPage, transaction, commandTimeout, buffered);
        }
        ...
        public IEnumerable<T> GetPage<T>(IDbConnection connection, int page, int resultsPerPage, out long allRowsCount, string sql, dynamic param = null, string allRowsCountSql = null, IDbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : class
        {
            ...
            IEnumerable<T> list = connection.Query<T>(pageSql.ToString(), dynamicParameters, transaction, buffered, commandTimeout, CommandType.Text);
