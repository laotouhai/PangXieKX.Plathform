...
namespace PangXieKX.Plathform.DB.DbUtils
{
    ...
    public class DataUtils
    {
        ...
        /// <returns></returns>
        //public static TEntity DataRowToEntity<TEntity>(DataRow row) where TEntity : class
        //{
        //    //2015-08-10注释
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        //public static TEntity[] DataTableToEntityArray<TEntity>(DataTable dt) where TEntity : class
        //{
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        //public static List<TEntity> DataTableToEntityList<TEntity>(DataTable dt) where TEntity : class
        //{
