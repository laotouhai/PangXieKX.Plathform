...
namespace PangXieKX.Plathform.DB
{
    ...
    public class DBUtils
    {
        ...
        public static IDbConnection CreateSqlConnection(string strKey, out DataBaseType dbType)
        {
        ...
        public static IDBHelper GetDBHelper(DataBaseType dbType)
        {
            ...
            if (!_iDBHelpers.TryGetValue(dbType, out dbHelper))
            {
                ...
                {
                    case DataBaseType.SqlServer:
                        dbHelper = new PangXieKX.Plathform.DB.SqlDBHelper.DBAdaptor();
                        break;
                    case DataBaseType.MySql:
                        dbHelper = new PangXieKX.Plathform.DB.MySqlDBHelper.MySqlAdaptor();
                        break;
                    case DataBaseType.Oracle:
                    //dbHelper = new PangXieKX.Plathform.DB.OracleDBHelper.OracleAdaptor();
                    //break;
                    default:
                        dbHelper = new PangXieKX.Plathform.DB.SqlDBHelper.DBAdaptor();
                        break;
